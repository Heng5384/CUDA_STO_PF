...
Top-level status: `FAIL_EULERIAN_TIME_ACCURACY`.
...
```json
{
  ...
  "BOUNDARY_ACTIVE_CFL": {
    "all_policies_accepted_boundary_active_step_count": 31,
    "all_policies_max_accepted_boundary_active_cfl": 1.763246720054622e+19,
    "capped_policies_accepted_boundary_active_step_count": 0,
    "capped_policies_max_accepted_boundary_active_cfl": 0.0,
    "first_accepted_step_cfl": 0.0,
    "terminal_dt_1_s_audit_boundary_active": true,
    "terminal_dt_1_s_audit_boundary_cfl": 1.4873971088388063e+19
  },
  ...
  "COMMIT": "0e80352bc0903f9f7bca082a98e693fe49b2f081",
  "CUDA_RERUN": false,
  ...
  "ESTIMATED_48H_COST": "NOT_PROJECTED_FROM_SHORT_DIAGNOSTIC",
  ...
  "IMPLICIT_ACCURACY_LADDER": "INCOMPLETE_DIAGNOSTIC_BUDGET",
  ...
  "NEXT_ACTION": "Continue the actual shared-horizon active-CFL ladder with a sufficient diagnostic budget; do not infer a transport-scheme block or run the cohort crosscheck, authority ladder, PF comparison, or local GP release yet.",
  "N_M0_ERROR": "NOT_EVALUATED",
  "P0_BLOCKERS": [
    "IMPLICIT_ACCURACY_LADDER_INCOMPLETE_DIAGNOSTIC_BUDGET",
