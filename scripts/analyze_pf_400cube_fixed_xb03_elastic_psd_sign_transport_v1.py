#!/usr/bin/env python3
"""No-dislocation 300 K transport audit for one 400^3 PF PSD trajectory.
...
PASS = "PASS_400CUBE_FIXED_XB03_ELASTIC_PSD_SIGN_TRANSPORT_V1"
TEMPERATURE_K = 300.0
...
def main() -> None:
    ...
    try:
        ...
        provenance = {"schema": "PF_400CUBE_FIXED_XB03_ELASTIC_PSD_SIGN_TRANSPORT_V1", "status": PASS, "temperature_K": TEMPERATURE_K, "fixed_matrix_xAg": fixed_matrix, "disabled_dislocation_terms": True, "forbidden_refit_scale_used": False, "absolute_experimental_kappa_claim": False, "input_sha256": {str(path): sha256(path) for path in (args.observables, args.particles, args.yu_config, args.contract, args.transport_module)}}
        ...
        (args.out / "status.txt").write_text("BLOCKED_400CUBE_FIXED_XB03_ELASTIC_PSD_SIGN_TRANSPORT_V1\n", encoding="utf-8")
