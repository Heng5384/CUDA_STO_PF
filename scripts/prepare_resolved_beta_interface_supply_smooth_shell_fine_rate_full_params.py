#!/usr/bin/env python3
"""Prepare the full-window fine-rate compact-bell acceptance run."""
...
OUT = ROOT / "params/resolved_beta_interface_supply_smooth_shell_fine_rate_full"
...
def main() -> None:
    ...
    case = "T380_upper_guard_dt0p005_bell_shell4nm_f0p0004_hsrc0p49_full19s"
    values.update({
    ...
    lines = [
        "# Full-window fine-rate compact-bell required-supply relay acceptance.",
    ...
    row = {
        ...
        "purpose": "full_window_clean_growth_no_overdrive_acceptance",
    }
