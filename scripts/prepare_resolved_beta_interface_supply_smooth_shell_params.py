#!/usr/bin/env python3
"""Prepare a compact-bell, wider interface-relay stability smoke."""
...
OUT = ROOT / "params/resolved_beta_interface_supply_smooth_shell"
...
def main() -> None:
    ...
    case = "T380_upper_guard_dt0p005_bell_shell4nm_f0p0005_hsrc0p49_smoke"
    values.update({
    ...
    lines = [
        "# Smooth spatial required-supply relay smoke.",
        "# A compact bell vanishes at both shell edges; no source is injected at the beta boundary.",
        "# Matrix-side xB/Y only. This remains a scenario diagnostic, not GP thermodynamics.",
        "",
    ]
    ...
    row = {
        ...
        "purpose": "smooth_spatial_source_gradient_stability_discriminator",
    }
