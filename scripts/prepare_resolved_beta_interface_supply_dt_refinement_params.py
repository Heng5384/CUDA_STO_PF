#!/usr/bin/env python3
"""Prepare a rate-preserving timestep-refinement test for interface relay."""
...
OUT = ROOT / "params/resolved_beta_interface_supply_dt_refinement"
...
def main() -> None:
    ...
    case = "T380_upper_guard_dt0p005_interface_shell2nm_f0p0005_hsrc0p49_smoke"
    # f/dt is unchanged from the prior f=0.001, dt=0.01 diagnostic.
    values.update({
    ...
    lines = [
        "# Rate-preserving timestep-refinement interface-relay smoke.",
        "# dt is halved and f_max_per_step is halved, so f/dt is unchanged.",
        "# This remains a required-supply scenario diagnostic, not GP thermodynamics.",
        "",
    ]
    ...
    row = {
        ...
        "purpose": "rate_preserving_timestep_stability_discriminator",
    }
