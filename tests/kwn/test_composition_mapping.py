...
class CompositionMappingTest(unittest.TestCase):
    ...
    def test_n8_round_trip_across_primary_constraint_range(self) -> None:
        """N8: AQ, 6 h, and 48 h matrix values round-trip to machine precision."""
    ...
    def test_n8_known_formula_value(self) -> None:
        """N8: the 6 h observation uses the documented analytical conversion."""
